            ...
            <div class="col-md-6 border-end pe-md-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="first_name" class="form-control bg-light border-0 shadow-none" required value="{{ old('first_name', $patient->first_name) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Apellidos *</label>
                        <input type="text" name="last_name" class="form-control bg-light border-0 shadow-none" required value="{{ old('last_name', $patient->last_name) }}">
                    </div>
                    
                    <div class="col-md-6">
                        <label class="form-label text-muted small">DNI *</label>
                        <input type="text" name="dni" class="form-control bg-light border-0 shadow-none" required value="{{ old('dni', $patient->dni) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Nacimiento *</label>
                        <input type="date" name="date_of_birth" class="form-control bg-light border-0 shadow-none" required value="{{ old('date_of_birth', $patient->date_of_birth) }}">
                    </div>
                    
                    <div class="col-md-12">
                        <label class="form-label text-muted small">Dirección</label>
                        <input type="text" name="address" class="form-control bg-light border-0 shadow-none" value="{{ old('address', $patient->address) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label text-muted small">Teléfono / Celular</label>
                        <input type="tel" name="phone" class="form-control bg-light border-0 shadow-none" value="{{ old('phone', $patient->phone) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Correo Electrónico</label>
                        <input type="email" name="email" class="form-control bg-light border-0 shadow-none" value="{{ old('email', $patient->email) }}">
                    </div>

                    <div class="col-md-12">
                        <label class="form-label text-muted small">Recomendado por</label>
                        <input type="text" name="recommendation" class="form-control bg-light border-0 shadow-none" value="{{ old('recommendation', $patient->recommendation) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 ps-md-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="obra_social" class="form-control bg-light border-0 shadow-none" value="{{ old('obra_social', $patient->obra_social) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Plan</label>
                        <input type="text" name="plan" class="form-control bg-light border-0 shadow-none" value="{{ old('plan', $patient->plan) }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label text-muted small">Nro. Afiliado</label>
                        <input type="text" name="affiliate_number" class="form-control bg-light border-0 shadow-none" value="{{ old('affiliate_number', $patient->affiliate_number) }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="profession" class="form-control bg-light border-0 shadow-none" value="{{ old('profession', $patient->profession) }}">
                    </div>
                    <div class="col-md-6">
                        <label class="form-label text-muted small">Nro. Siniestro (Legales)</label>
                        <input type="text" name="nro_siniestro" class="form-control bg-light border-0 shadow-none" value="{{ old('nro_siniestro', $patient->nro_siniestro) }}">
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="medical_notes" rows="4" class="form-control bg-light border-0 shadow-none" placeholder="Especifique cirugías (ej. Cataratas OD, Lasik OI), antecedentes, alergias...">{{ old('medical_notes', $patient->medical_notes) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
